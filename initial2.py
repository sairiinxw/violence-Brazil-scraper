...
#scraping text output file: output18.txt
#csv output file: clean_articles18.csv
...
csv_output_file = 'clean_articles18.csv'
scrapeNum = 1000 # number of articles you want to scrape
